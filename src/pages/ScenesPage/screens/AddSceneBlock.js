...
import SceneCategoryTVIcon from "../../../components/icons/SceneCategoryTVIcon/SceneCategoryTVIcon";
import AddSceneBlockItem from "./AddSceneBlockItem/AddSceneBlockItem";
...
const AddSceneBlock = ({closeAction, addSceneAction}) => {
                            ...
                            <div className="flex flex-row gap-[1rem]">
                                {
                                    categoryList.map((item) =>
                                        <AddSceneBlockItem icon={item.icon} name={item.name} id={item.id}
                                                           active={item.active}
