...
const ContentSceneScreen = ({listItems, scenesItems, flagScreen, addSceneAction, activeDetailSceneAction}) => {
                ...
                <div className="grid grid-cols-2 gap-[2rem] mt-[2rem]">
                    {
                        listItems.map((item, index) =>
                            <SceneItem icon={item.icon} name={item.name} rooms={item.rooms} key={item + index}
...
export default ContentSceneScreen;